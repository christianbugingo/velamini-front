...
const PLANS: Plan[] = [
  {
    ...
    messages: 200,
    accent: "#34D399",
    features: ["200 messages/month", "Personal virtual self", "Chat link sharing", "Basic analytics"],
  },
  {
    id: "plus",
    name: "Plus",
          ...
          {!alreadyPlus && (
            <div className="ub-upgrade-prompt">
              <div className="ub-upgrade-prompt-text">
                ...
                <p>Get 1,500 messages/month, resume generation, and priority support for 3,000 RWF/month.</p>
              </div>
          ...
          >
            ...
            >
              ...
              <div className="ub-plan-card">
                <div className="ub-plan-card-top">
                  ...
                  <div>
                    ...
                    <div className="ub-plan-card-price"><strong>3,000 RWF</strong>/month</div>
                  </div>
                </div>
              ...
              >
                ...
                {paying ? "Processing…" : "Pay 3,000 RWF via Mobile Money"}
              </button>
            </motion.div>
          </motion.div>
        )}
